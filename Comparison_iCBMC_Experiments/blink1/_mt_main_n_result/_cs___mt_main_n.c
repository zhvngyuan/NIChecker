/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-24 08:49:36
 ***
 ...
 ***
 ***  params:
 ***    --input /home/dell/zyworkspace/nichecker/Experiment/icbmc/blink1/_mt_main_n.c --unwind 2 --rounds 2
 ***
 ***  mode:
 ***
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {4, 6, 5, 5, 1};
...
IF(4,0,tTimer_Force_isr_0_1)
                                   ...
                                   static _Bool __cs_local_Timer_Force_isr___cs_tmp_if_cond_4;
                                   
                                   __cs_local_Timer_Force_isr___cs_tmp_if_cond_4 = timerCount != 0;
                                   
                                   if (__cs_local_Timer_Force_isr___cs_tmp_if_cond_4)
...
/* Timer_B_isr_0 random prio:2 */
                                   ...
                                   if ((__cs_disable_thread[3] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 5)))
                                   {
