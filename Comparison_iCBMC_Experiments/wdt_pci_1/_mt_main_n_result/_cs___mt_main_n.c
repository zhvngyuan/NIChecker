/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-24 09:35:39
 ***
 ...
 ***
 ***  params:
 ***    --input /home/dell/zyworkspace/nichecker/Experiment/icbmc/wdt_pci_1/_mt_main_n.c --unwind 2 --rounds 2
 ***
 ***  mode:
 ***
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[4] __cs_thread_lines[] = {5, 1, 1, 10, 7, 7};
...
twriter1_isr_0_2: IF(4,2,twriter1_isr_0_3)
                                   ...
                                   __cs_local_writer1_isr___cs_tmp_if_cond_9 = count;
...
twriter1_isr_0_4: IF(4,4,twriter1_isr_0_5)
                                                       ...
                                                       __cs_local_writer1_isr___cs_tmp_if_cond_11 = wdtpci_write_buf != 'V';
...
twriter2_isr_0_1: IF(5,1,twriter2_isr_0_2)
                                   
                                   expect_close = 0;
                                   
                                   static _Bool __cs_local_writer2_isr___cs_tmp_if_cond_12;
                                   
twriter2_isr_0_2: IF(5,2,twriter2_isr_0_3)
                                   
                                   __cs_local_writer2_isr___cs_tmp_if_cond_12 = count;
...
twriter2_isr_0_3: IF(5,3,twriter2_isr_0_4)
...
twriter2_isr_0_4: IF(5,4,twriter2_isr_0_5)
                                                       
                                                       __cs_local_writer2_isr___cs_tmp_if_cond_14 = wdtpci_write_buf != 'V';
                                                       
                                                       if (__cs_local_writer2_isr___cs_tmp_if_cond_14)
                         
                                                                                     {
                                                                 
twriter2_isr_0_5: IF(5,5,twriter2_isr_0_6)
...
twriter2_isr_0_6: IF(5,6,twriter2_isr_0_7)
...
IF(1,0,tmain_task_0_1)
                                   ...
                                   static int __cs_local_main_task_test;
                                   
                                   __cs_local_main_task_test = 0;
...
/* writer1_isr_0 random prio:2 */
                                   ...
                                   if (((__cs_disable_thread[4] != 1) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 10))) && ((__cs_pc[5] == 0) || (__cs_pc[5] == 7)))
                                   {
...
/* writer2_isr_0 random prio:2 */
                                   ...
                                   if (((__cs_disable_thread[5] != 1) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 10))) && ((__cs_pc[4] == 0) || (__cs_pc[4] == 7)))
                                   {
...
/* main_task_0 */
                                   ...
                                   if ((((__cs_disable_thread[1] != 1) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 10))) && ((__cs_pc[4] == 0) || (__cs_pc[4] == 7))) && ((__cs_pc[5] == 0) || (__cs_pc[5] == 7)))
                                   {
