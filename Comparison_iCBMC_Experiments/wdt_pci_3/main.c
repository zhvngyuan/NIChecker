...
const int __CPROVER_thread_priorities[] = {5, 3, 2, 1, 2, 2, 3, 4};
const char* __CPROVER_threads[] = {"c::closer1", "c::closer2", "c::closer3", "c::closer4", "c::writer1", "c::writer2", "c::writer3", "c::writer4"};
