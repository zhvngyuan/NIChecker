/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-22 13:24:01
 ***
 ...
 ***
 ***  params:
 ***    --input /home/dell/zyworkspace/nichecker/Experiment/Testrealpro/i8xx_tco_2/_mt_main.c --unwind 2 --rounds 2
 ***
 ***  mode:
 ***    wwr
 ***    int
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {1, 3, 5, 6, 3, 1};
...
IF(4,0,twriter1_isr_0_1)
                         
                                             {
                                                       ...
                                                       __cs_local_writer1_isr___cs_tmp_if_cond_11 = 0;
...
twriter1_isr_0_1: IF(4,1,twriter1_isr_0_2)
                                                                           ...
                                                                           __cs_local_writer1_isr___cs_tmp_if_cond_13 = tco_write_buf == 'V';
...
tcloser1_isr_0_2: IF(2,2,tcloser1_isr_0_3)
                                                                           ...
                                                                           __cs_local_closer1_isr___cs_tmp_if_cond_9 = tco_write_buf == 'V';
...
tcloser1_isr_0_4: IF(2,4,tcloser1_isr_0_5)
                                   ...
                                   __cs_local_closer1_isr___cs_tmp_if_cond_10 = tco_expect_close == 42;
...
tmain_task_0_2: IF(1,2,tmain_task_0_3)
                                   {
                                             ...
                                             __cs_local_main_task_reader4 = nondet_int();
...
tcloser2_isr_0_1: IF(3,1,tcloser2_isr_0_2)
                                             ...
                                             wwr_w_tmp3_num++; //add
                                             wwr_w_tmp3 = tco_expect_close; //add
...
tcloser2_isr_0_2: IF(3,2,tcloser2_isr_0_3)
                                                                           ...
                                                                           __cs_local_closer2_isr___cs_tmp_if_cond_5 = tco_write_buf == 'V';
...
tcloser2_isr_0_4: IF(3,4,tcloser2_isr_0_5)
                                             ...
                                             wwr_r2 = tco_expect_close; //add
                                             if(wwr_w_tmp3_num != 0){
                                             	 assert(wwr_r2==wwr_w_tmp3);
                                             	 wwr_w_tmp3_num = 0;
                                             }
...
/* closer1_isr_0 random prio:1 */
                                   ...
                                   if (((__cs_disable_thread[2] != 1) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 6))) && ((__cs_pc[4] == 0) || (__cs_pc[4] == 3)))
                                   {
...
/* writer1_isr_0 random prio:2 */
                                   ...
                                   if ((__cs_disable_thread[4] != 1) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 6)))
                                   {
...
/* main_task_0 */
                                   ...
                                   if ((((__cs_disable_thread[1] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 5))) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 6))) && ((__cs_pc[4] == 0) || (__cs_pc[4] == 3)))
                                   {
