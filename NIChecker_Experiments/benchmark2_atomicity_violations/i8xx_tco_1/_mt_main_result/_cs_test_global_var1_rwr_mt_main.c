/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-22 13:23:42
 ***
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {1, 6, 3, 1, 1};
...
IF(3,0,tcloser1_isr_0_1)
                                   ...
                                   __cs_local_closer1_isr___cs_tmp_if_cond_5 = test_global_condition3 == 1;
...
IF(2,0,tcloser2_isr_0_1)
                                   ...
                                   if (__cs_local_closer2_isr___cs_tmp_if_cond_2)
                         
                                             {
                                                       ...
                                                       __cs_local_closer2_isr___cs_tmp_if_cond_3 = test_global_condition1 == 1;
...
tcloser2_isr_0_1: IF(2,1,tcloser2_isr_0_2)
                                                       ...
                                                       __cs_local_closer2_isr___cs_tmp_if_cond_4 = test_global_condition2 == 1;
...
/* closer2_isr_0 random prio:2 */
                                   ...
                                   if ((__cs_disable_thread[2] != 1) && ((__cs_pc[4] == 0) || (__cs_pc[4] == 1)))
                                   {
...
/* writer1_isr_0 random prio:2 */
                                   ...
                                   if ((__cs_disable_thread[4] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 3)))
                                   {
...
/* main_task_0 */
                                   ...
                                   if (((__cs_disable_thread[1] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 3))) && ((__cs_pc[4] == 0) || (__cs_pc[4] == 1)))
                                   {
