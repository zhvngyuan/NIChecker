/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-22 13:23:51
 ***
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {1, 3, 6, 1, 3};
...
IF(4,0,twriter1_isr_0_1)
                         
                                             {
                                                       ...
                                                       __cs_local_writer1_isr___cs_tmp_if_cond_8 = 0;
                                                       ...
                                                       if (__cs_local_writer1_isr___cs_tmp_if_cond_8)
                                                                 ...
                                                                 __cs_local_writer1_isr___cs_tmp_if_cond_9 = ! nowayout;
                                             ...
                                             wwr_w_tmp4_num++; //add
                                             wwr_w_tmp4 = tco_expect_close; //add
...
twriter1_isr_0_1: IF(4,1,twriter1_isr_0_2)
                                                                           ...
                                                                           __cs_local_writer1_isr___cs_tmp_if_cond_10 = tco_write_buf == 'V';
...
twriter1_isr_0_2: IF(4,2,twriter1_isr_0_3)
                                   ...
                                   __cs_local_writer1_isr_maxnum = nondet_int();
                                   
                                   static int __cs_local_writer1_isr_mininum;
                                   __cs_local_writer1_isr_mininum = nondet_int();
                                   
                                   __cs_local_writer1_isr_i = 0;
                                   
                                   static int __cs_local_writer1_isr_loop_1_IOVar1;
                                   
                                   static int __cs_local_writer1_isr_loop_1_block_1;
                                   
                                   static int __cs_local_writer1_isr_t_1;
                                   __cs_local_writer1_isr_t_1 = 0;
                                   
                                   if (! ((__cs_local_writer1_isr_t_1 < 1) && (__cs_local_writer1_isr_i < 10000)))
                                   ...
                                   ;
                                             ...
                                             __cs_local_writer1_isr_loop_1_block_1 = nondet_int();
                                             
                                             __cs_local_writer1_isr_i = __cs_local_writer1_isr_loop_1_IOVar1 + (1 * __cs_local_writer1_isr_loop_1_block_1);
                                             
                                             __CPROVER_assume(__cs_local_writer1_isr_loop_1_block_1 >= 0);
                                   ...
                                   __cs_loop_1 = (__cs_local_writer1_isr_t_1 < 1) && (__cs_local_writer1_isr_i < 10000);
...
IF(3,0,tcloser1_isr_0_1)
                                   ...
                                   __cs_local_closer1_isr___cs_tmp_if_cond_4 = test_global_condition3 == 1;
                                   ...
                                   tco_write_buf = 'V';
                         
                                             {
                                                       ...
                                                       __cs_local_closer1_isr___cs_tmp_if_cond_5 = 1;
                                                       ...
                                                       if (__cs_local_closer1_isr___cs_tmp_if_cond_5)
                                                                 ...
                                                                 __cs_local_closer1_isr___cs_tmp_if_cond_6 = ! nowayout;
                                                                 ...
                                                                 if (__cs_local_closer1_isr___cs_tmp_if_cond_6)
                                                                           ...
                                                                           __cs_local_closer1_isr___cs_tmp_if_cond_7 = tco_write_buf == 'V';
...
IF(1,0,tmain_task_0_1)
                                   ...
                                   tco_expect_close = 0;
                                             ...
                                             wwr_w_tmp1_num++; //add
                                             wwr_w_tmp1 = tco_expect_close; //add
...
tcloser2_isr_0_1: IF(2,1,tcloser2_isr_0_2)
                                             ...
                                             wwr_w_tmp2_num++; //add
                                             wwr_w_tmp2 = tco_expect_close; //add
                         
                                                                           
tcloser2_isr_0_2: IF(2,2,tcloser2_isr_0_3)
                                                                           
                                                                           static _Bool __cs_local_closer2_isr___cs_tmp_if_cond_2;
                                                                           
                                                                           __cs_local_closer2_isr___cs_tmp_if_cond_2 = tco_write_buf == 'V';
...
tcloser2_isr_0_3: IF(2,3,tcloser2_isr_0_4)
                                                                           }
...
tcloser2_isr_0_4: IF(2,4,tcloser2_isr_0_5)
                                   
                                   static _Bool __cs_local_closer2_isr___cs_tmp_if_cond_3;
                                   
                                   __cs_local_closer2_isr___cs_tmp_if_cond_3 = tco_expect_close == 42;
                         
                                             wwr_r1 = tco_expect_close; //add
                                             if(wwr_w_tmp2_num != 0){
...
tcloser2_isr_0_5: IF(2,5,tcloser2_isr_0_6)
                                             }
...
/* closer2_isr_0 random prio:2 */
                                   ...
                                   if ((__cs_disable_thread[2] != 1) && ((__cs_pc[4] == 0) || (__cs_pc[4] == 3)))
                                   {
...
/* writer1_isr_0 random prio:2 */
                                   ...
                                   if ((__cs_disable_thread[4] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 6)))
                                   {
...
/* main_task_0 */
                                   ...
                                   if (((__cs_disable_thread[1] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 6))) && ((__cs_pc[4] == 0) || (__cs_pc[4] == 3)))
                                   {
