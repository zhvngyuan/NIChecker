/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-22 13:21:04
 ***
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[2] __cs_thread_lines[] = {1, 2, 2, 1};
                         ...
                         int* __cs_variable_address = &intervalCounter;   //add 
...
IF(2,0,ttask_measure_isr_0_1)
                                   ...
                                   __cs_temporary_0 = intervalCounter + 1;
                         
                                             rww_r_tmp2_num++; //add
                                             rww_r_tmp2 = intervalCounter; //add
                         
                                   
ttask_measure_isr_0_1: IF(2,1,ttask_measure_isr_0_2)
                         
                                             rww_w1 = intervalCounter; //add
                                             if(rww_r_tmp2_num != 0){
                                             	 assert(rww_w1==rww_r_tmp2);
                                             	 rww_r_tmp2_num = 0;
                                             }
                         
                                   intervalCounter = __cs_temporary_0;
