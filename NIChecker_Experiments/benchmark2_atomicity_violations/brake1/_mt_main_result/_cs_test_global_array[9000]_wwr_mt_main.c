/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-22 13:22:18
 ***
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {1, 2, 1, 5};
...
IF(3,0,ttask_RR_Wheel_isr_0_1)
                                   ...
                                   static int __cs_local_task_RR_Wheel_isr_loop_1_block_3;
                                   ...
                                   ;
                                             ...
                                             __CPROVER_assume(__cs_local_task_RR_Wheel_isr_i < 10000);
                                                       ...
                                                       static _Bool __cs_local_task_RR_Wheel_isr___cs_tmp_if_cond_0;
                                             ...
                                             wwr_w_tmp3_num++; //add
                                             wwr_w_tmp3 = test_global_array[9000]; //add
...
ttask_RR_Wheel_isr_0_4: IF(3,4,ttask_RR_Wheel_isr_0_5)
                                   ...
                                   __cs_loop_1 = (__cs_local_task_RR_Wheel_isr_t_1 < 2) && (__cs_local_task_RR_Wheel_isr_i < 10000);
...
/* main_task_0 */
                                   ...
                                   if ((__cs_disable_thread[1] != 1) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 5)))
                                   {
