/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-22 13:22:58
 ***
 ...
 ***
 ***  params:
 ***    --input /home/dell/zyworkspace/nichecker/Experiment/Testrealpro/i2c_pca_isa_1/_mt_main.c --unwind 2 --rounds 2
 ***
 ***  mode:
 ***    rwr
 ***    int
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {1, 5, 1, 1, 1, 1};
...
IF(3,0,treq2_isr_0_1)
                                   ...
                                   static int __cs_local_req2_isr_reader;
                                   __cs_local_req2_isr_reader = nondet_int();
...
IF(5,0,treq4_isr_0_1)
                                   ...
                                   static _Bool __cs_local_req4_isr___cs_tmp_if_cond_6;
                                   
                                   __cs_local_req4_isr___cs_tmp_if_cond_6 = irq == (- 1);
                                   
                                   if (__cs_local_req4_isr___cs_tmp_if_cond_6)
                         
                                             {
                                             
                                             static _Bool __cs_local_req4_isr___cs_tmp_if_cond_7;
                                             
                                             __cs_local_req4_isr___cs_tmp_if_cond_7 = test_global_condition3 == 1;
                                             
                                             if (__cs_local_req4_isr___cs_tmp_if_cond_7)
...
IF(4,0,treq3_isr_0_1)
                                   ...
                                   __cs_local_req3_isr___cs_tmp_if_cond_4 = irq == 3;
                                   ...
                                   ;
                                             ...
                                             static _Bool __cs_local_req3_isr___cs_tmp_if_cond_5;
                                             
                                             __cs_local_req3_isr___cs_tmp_if_cond_5 = irq > (- 1);
                                             
                                             if (__cs_local_req3_isr___cs_tmp_if_cond_5)
