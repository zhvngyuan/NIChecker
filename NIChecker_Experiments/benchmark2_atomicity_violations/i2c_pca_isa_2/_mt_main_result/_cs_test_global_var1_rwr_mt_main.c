/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-22 13:23:10
 ***
 ...
 ***
 ***  params:
 ***    --input /home/dell/zyworkspace/nichecker/Experiment/Testrealpro/i2c_pca_isa_2/_mt_main.c --unwind 2 --rounds 2
 ***
 ***  mode:
 ***    rwr
 ***    int
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {1, 4, 2, 2, 2, 2, 1, 4};
...
treq6_isr_0_1: IF(7,1,treq6_isr_0_2)
                                             ...
                                             static int __cs_local_req6_isr_reader1;
                                             
                                             static int __cs_local_req6_isr_reader2;
                                             
                                             static int __cs_local_req6_isr_reader3;
                                             __cs_local_req6_isr_reader3 = nondet_int();
                                             
                                             static int __cs_local_req6_isr_reader4;
                                             __cs_local_req6_isr_reader4 = nondet_int();
                                             
                                             static _Bool __cs_local_req6_isr___cs_tmp_if_cond_0;
                                             
                                             __cs_local_req6_isr___cs_tmp_if_cond_0 = test_global_condition1 == 1;
                                             
                                             if (__cs_local_req6_isr___cs_tmp_if_cond_0)
                         
                                                                 {
                                                       
                                                       __cs_local_req6_isr_reader1 = test_global_var1;
                         
                                             rwr_r1 = test_global_var1; //add
                                             if(rwr_tmp7_num != 0){  //add
                                             	 assert(rwr_r1 == rwr_tmp7);
                                             }
                                             rwr_tmp7_num++;
                                             rwr_tmp7 = rwr_r1; 
                         
                                                       
treq6_isr_0_2: IF(7,2,treq6_isr_0_3)
                                             }
                                             ...
                                             static _Bool __cs_local_req6_isr___cs_tmp_if_cond_1;
                                             
                                             __cs_local_req6_isr___cs_tmp_if_cond_1 = test_global_condition2 == 1;
                                             
                                             if (__cs_local_req6_isr___cs_tmp_if_cond_1)
                         
                                                                 {
                                                       
                                                       __cs_local_req6_isr_reader2 = test_global_var1;
                         
                                             rwr_r2 = test_global_var1; //add
                                             if(rwr_tmp7_num != 0){  //add
                                             	 assert(rwr_r2 == rwr_tmp7);
                                             }
                                             rwr_tmp7_num++;
                                             rwr_tmp7 = rwr_r2; 
                         
                                                       
treq6_isr_0_3: IF(7,3,treq6_isr_0_4)
                                             }
...
treq4_isr_0_1: IF(5,1,treq4_isr_0_2)
                                   ...
                                   static _Bool __cs_local_req4_isr___cs_tmp_if_cond_5;
                                   
                                   __cs_local_req4_isr___cs_tmp_if_cond_5 = irq == 0;
                                   
                                   if (__cs_local_req4_isr___cs_tmp_if_cond_5)
...
IF(6,0,treq5_isr_0_1)
                                   ...
                                   ;
                                             ...
                                             static _Bool __cs_local_req5_isr___cs_tmp_if_cond_2;
                                             
                                             __cs_local_req5_isr___cs_tmp_if_cond_2 = irq > (- 1);
                                   ...
                                   static _Bool __cs_local_req5_isr___cs_tmp_if_cond_3;
                                   
                                   __cs_local_req5_isr___cs_tmp_if_cond_3 = irq == 0;
                                   
                                   if (__cs_local_req5_isr___cs_tmp_if_cond_3)
                         
                                             {
                                             
                                             static _Bool __cs_local_req5_isr___cs_tmp_if_cond_4;
                                             
                                             __cs_local_req5_isr___cs_tmp_if_cond_4 = test_global_condition1 == 1;
                                             
                                             if (__cs_local_req5_isr___cs_tmp_if_cond_4)
...
/* req1_isr_0 random prio:2 */
                                   ...
                                   if (((((__cs_disable_thread[2] != 1) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 2))) && ((__cs_pc[4] == 0) || (__cs_pc[4] == 2))) && ((__cs_pc[5] == 0) || (__cs_pc[5] == 2))) && ((__cs_pc[7] == 0) || (__cs_pc[7] == 4)))
                                   {
...
/* req2_isr_0 random prio:3 */
                                   ...
                                   if (((__cs_disable_thread[3] != 1) && ((__cs_pc[4] == 0) || (__cs_pc[4] == 2))) && ((__cs_pc[5] == 0) || (__cs_pc[5] == 2)))
                                   {
...
/* req3_isr_0 random prio:4 */
                                   ...
                                   if ((__cs_disable_thread[4] != 1) && ((__cs_pc[5] == 0) || (__cs_pc[5] == 2)))
                                   {
...
/* req6_isr_0 random prio:2 */
                                   ...
                                   if (((((__cs_disable_thread[7] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 2))) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 2))) && ((__cs_pc[4] == 0) || (__cs_pc[4] == 2))) && ((__cs_pc[5] == 0) || (__cs_pc[5] == 2)))
                                   {
...
/* main_task_0 */
                                   ...
                                   if ((((((__cs_disable_thread[1] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 2))) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 2))) && ((__cs_pc[4] == 0) || (__cs_pc[4] == 2))) && ((__cs_pc[5] == 0) || (__cs_pc[5] == 2))) && ((__cs_pc[7] == 0) || (__cs_pc[7] == 4)))
                                   {
