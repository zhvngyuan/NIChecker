...
void closer2_isr(void) { 
    ...
    //while(cnt2 < LIMIT) {
        ...
        cnt2++;
	  int reader;
	  if(test_global_condition1 == 1) reader = test_global_var2;
    //}
    return NULL;
}
...
void closer4_isr(void) {
    //while(cnt8 < LIMIT) {
	  ...
	  if(test_global_condition3 == 1) test_global_var2 = 1;
        if(test_global_condition4 == 1) test_global_var2 = 1;
        expect_close = 0;
        //up(open_sem);
        cnt8++;
    //}
