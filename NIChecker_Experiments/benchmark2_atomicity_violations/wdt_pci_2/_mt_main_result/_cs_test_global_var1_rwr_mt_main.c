/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-22 13:24:49
 ***
 ...
 ***
 ***  params:
 ***    --input /home/dell/zyworkspace/nichecker/Experiment/Testrealpro/wdt_pci_2/_mt_main.c --unwind 2 --rounds 2
 ***
 ***  mode:
 ***    rwr
 ***    int
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {1, 6, 4, 2, 1, 1, 1, 1};
...
IF(4,0,tcloser3_isr_0_1)
                                   ...
                                   static _Bool __cs_local_closer3_isr___cs_tmp_if_cond_5;
                                   ...
                                   if (__cs_local_closer3_isr___cs_tmp_if_cond_5)
                                             ...
                                             static _Bool __cs_local_closer3_isr___cs_tmp_if_cond_6;
                                   ...
                                   static _Bool __cs_local_closer3_isr___cs_tmp_if_cond_7;
...
IF(5,0,twriter1_isr_0_1)
                                   ...
                                   __cs_local_writer1_isr___cs_tmp_if_cond_15 = test_global_condition3 == 1;
...
tcloser1_isr_0_1: IF(2,1,tcloser1_isr_0_2)
                                   ...
                                   if (__cs_local_closer1_isr___cs_tmp_if_cond_8)
                                             ...
                                             ;
                                                       ...
                                                       static int __cs_local_closer1_isr_reader1;
                                                       
                                                       static int __cs_local_closer1_isr_reader2;
                                                       
                                                       static int __cs_local_closer1_isr_reader3;
                                                       __cs_local_closer1_isr_reader3 = nondet_int();
                                                       
                                                       static int __cs_local_closer1_isr_reader4;
                                                       __cs_local_closer1_isr_reader4 = nondet_int();
                                                       
                                                       static _Bool __cs_local_closer1_isr___cs_tmp_if_cond_10;
                                                       
                                                       __cs_local_closer1_isr___cs_tmp_if_cond_10 = test_global_condition1 == 1;
                                                       
                                                       if (__cs_local_closer1_isr___cs_tmp_if_cond_10)
                         
                                                                                     {
                                                                 
                                                                 __cs_local_closer1_isr_reader1 = test_global_var1;
...
tcloser1_isr_0_2: IF(2,2,tcloser1_isr_0_3)
                                                       ...
                                                       __cs_local_closer1_isr___cs_tmp_if_cond_11 = test_global_condition2 == 1;
                                                       
                                                       if (__cs_local_closer1_isr___cs_tmp_if_cond_11)
                         
                                                                                     {
                                                                 
                                                                 __cs_local_closer1_isr_reader2 = test_global_var1;
...
tcloser1_isr_0_3: IF(2,3,tcloser1_isr_0_4)
                                   ...
                                   __cs_local_closer1_isr___cs_tmp_if_cond_12 = expect_close != 42;
...
IF(7,0,twriter3_isr_0_1)
                                   ...
                                   static _Bool __cs_local_writer3_isr___cs_tmp_if_cond_16;
                                   
                                   __cs_local_writer3_isr___cs_tmp_if_cond_16 = count;
                                   ...
                                   if (__cs_local_writer3_isr___cs_tmp_if_cond_16)
                                             ...
                                             __cs_local_writer3_isr___cs_tmp_if_cond_17 = ! nowayout;
                                   ...
                                   static int __cs_local_writer3_isr_i;
                                   __cs_local_writer3_isr_i = 0;
                                   
                                   static int __cs_local_writer3_isr_maxnum;
                                   __cs_local_writer3_isr_maxnum = nondet_int();
                                   
                                   static int __cs_local_writer3_isr_mininum;
                                   __cs_local_writer3_isr_mininum = nondet_int();
                                   
                                   __cs_local_writer3_isr_i = 0;
                                   
                                   static int __cs_local_writer3_isr_loop_1_IOVar1;
                                   
                                   static int __cs_local_writer3_isr_loop_1_block_1;
                                   
                                   static int __cs_local_writer3_isr_t_1;
                                   __cs_local_writer3_isr_t_1 = 0;
                                   
                                   if (! ((__cs_local_writer3_isr_t_1 < 1) && (__cs_local_writer3_isr_i < 10000)))
                                   ...
                                   ;
                                             ...
                                             __cs_local_writer3_isr_loop_1_block_1 = nondet_int();
                                             
                                             __cs_local_writer3_isr_i = __cs_local_writer3_isr_loop_1_IOVar1 + (1 * __cs_local_writer3_isr_loop_1_block_1);
                                             
                                             __CPROVER_assume(__cs_local_writer3_isr_loop_1_block_1 >= 0);
                                   ...
                                   __cs_loop_1 = (__cs_local_writer3_isr_t_1 < 1) && (__cs_local_writer3_isr_i < 10000);
...
/* closer2_isr_0 random prio:2 */
                                   ...
                                   if ((__cs_disable_thread[3] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 4)))
                                   {
...
/* writer3_isr_0 random prio:1 */
                                   
                                   unsigned __CPROVER_bitvector[1] __cs_tmp_t7_r0;
                                   
                                   if (((__cs_disable_thread[7] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 4))) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 2)))
                                   {
...
/* main_task_0 */
                                   ...
                                   if ((((__cs_disable_thread[1] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 4))) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 2))) && ((__cs_pc[7] == 0) || (__cs_pc[7] == 1)))
                                   {
