/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-22 13:24:59
 ***
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {1, 2, 1, 1, 1, 1, 1, 5};
...
IF(7,0,twriter3_isr_0_1)
                                   ...
                                   static _Bool __cs_local_writer3_isr___cs_tmp_if_cond_13;
                                   ...
                                   static int __cs_local_writer3_isr_loop_1_block_3;
                                   ...
                                   if (! ((__cs_local_writer3_isr_t_1 < 2) && (__cs_local_writer3_isr_i < 10000)))
                                             ...
                                             __CPROVER_assume(__cs_pc_cs[7] >= 5);
                                             __cs_pc[7] = 4;
                                             goto twriter3_isr_0_1;
                                   ...
                                   ;
                                             ...
                                             wwr_w_tmp7_num++; //add
                                             wwr_w_tmp7 = test_global_array[9000]; //add
                         
                                                                 
twriter3_isr_0_1: IF(7,1,twriter3_isr_0_2)
                                                       }
...
twriter3_isr_0_2: IF(7,2,twriter3_isr_0_3)
                                                       }
...
twriter3_isr_0_3: IF(7,3,twriter3_isr_0_4)
                                                       }
...
twriter3_isr_0_4: IF(7,4,twriter3_isr_0_5)
                                                       }
                                   ...
                                   __cs_loop_1 = (__cs_local_writer3_isr_t_1 < 2) && (__cs_local_writer3_isr_i < 10000);
...
/* closer1_isr_0 random prio:2 */
                                   ...
                                   if ((__cs_disable_thread[2] != 1) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 1)))
                                   {
...
/* closer2_isr_0 random prio:2 */
                                   ...
                                   if ((__cs_disable_thread[3] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 1)))
                                   {
...
/* writer3_isr_0 random prio:1 */
                                   ...
                                   if (((__cs_disable_thread[7] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 1))) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 1)))
                                   {
...
/* main_task_0 */
                                   ...
                                   if ((((__cs_disable_thread[1] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 1))) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 1))) && ((__cs_pc[7] == 0) || (__cs_pc[7] == 5)))
                                   {
