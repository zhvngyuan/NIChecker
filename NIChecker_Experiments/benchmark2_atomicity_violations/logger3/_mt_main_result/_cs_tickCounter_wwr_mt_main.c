/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-22 13:21:23
 ***
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[2] __cs_thread_lines[] = {1, 2, 1, 2, 1, 2};
...
/* task_measure2_isr_0 random prio:2 */
                                   ...
                                   if (((__cs_disable_thread[3] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 1))) && ((__cs_pc[5] == 0) || (__cs_pc[5] == 2)))
                                   {
...
/* task_communicate_isr_0 random prio:3 */
                                   ...
                                   if ((__cs_disable_thread[5] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 1)))
                                   {
...
/* main_task_0 */
                                   ...
                                   if ((((__cs_disable_thread[1] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 1))) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 2))) && ((__cs_pc[5] == 0) || (__cs_pc[5] == 2)))
                                   {
