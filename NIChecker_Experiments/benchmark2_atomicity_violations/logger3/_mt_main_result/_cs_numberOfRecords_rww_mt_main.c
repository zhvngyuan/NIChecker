/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-22 13:21:19
 ***
 ...
 ***
 ***  params:
 ***    --input /home/dell/zyworkspace/nichecker/Experiment/Testrealpro/logger3/_mt_main.c --unwind 2 --rounds 2
 ***
 ***  mode:
 ***    rww
 ***    int
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {1, 2, 5, 1, 1, 3};
                         ...
                         int* __cs_variable_address = &numberOfRecords;   //add 
...
IF(2,0,ttask_measure1_isr_0_1)
                                   ...
                                   records[numberOfRecords] = __cs_local_task_measure1_isr_value;
                         
                                             rww_r_tmp2_num++; //add
                                             rww_r_tmp2 = numberOfRecords; //add
...
ttask_measure1_isr_0_2: IF(2,2,ttask_measure1_isr_0_3)
                                   ...
                                   __cs_temporary_0 = numberOfRecords + 1;
...
ttask_measure1_isr_0_3: IF(2,3,ttask_measure1_isr_0_4)
                                             ...
                                             rww_w1 = numberOfRecords; //add
                                             if(rww_r_tmp2_num != 0){
                                             	 assert(rww_w1==rww_r_tmp2);
                                             	 rww_r_tmp2_num = 0;
                                             }
                         
                                   numberOfRecords = __cs_temporary_0;
...
IF(5,0,ttask_communicate_isr_0_1)
                                   ...
                                   if (__cs_local_task_communicate_isr___cs_tmp_if_cond_0)
                                             ...
                                             rww_r_tmp5_num++; //add
                                             rww_r_tmp5 = numberOfRecords; //add
                         
                                                                 
ttask_communicate_isr_0_1: IF(5,1,ttask_communicate_isr_0_2)
                         
                                             rww_w2 = numberOfRecords; //add
                                             if(rww_r_tmp5_num != 0){
                                             	 assert(rww_w2==rww_r_tmp5);
                                             	 rww_r_tmp5_num = 0;
                                             }
...
/* task_measure2_isr_0 random prio:2 */
                                   ...
                                   if (((__cs_disable_thread[3] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 5))) && ((__cs_pc[5] == 0) || (__cs_pc[5] == 3)))
                                   {
...
/* task_measure3_isr_0 random prio:6 */
...
/* main_task_0 */
                                   ...
                                   if ((((__cs_disable_thread[1] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 5))) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 1))) && ((__cs_pc[5] == 0) || (__cs_pc[5] == 3)))
                                   {
