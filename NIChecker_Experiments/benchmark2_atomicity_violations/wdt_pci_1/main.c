...
void closer2_isr(void) {
    ...
    //while(cnt2 < LIMIT) {
        ...
        if (count) { 
	     ...
	     if(test_global_condition3 == 1) reader5 = test_global_var3;
	     if(test_global_condition4 == 1) reader6 = test_global_var3;
        } 
...
void writer2_isr(void) {
    ...
    //while (cnt4 < LIMIT) {
        ...
        cnt4++;
	  if(test_global_condition3 == 0) test_global_var2 = 0x55;
