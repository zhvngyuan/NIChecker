/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-22 13:24:44
 ***
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {1, 5, 2, 4, 1, 1};
...
/* main_task_0 */
                                   ...
                                   if (((__cs_disable_thread[1] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 2))) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 4)))
                                   {
