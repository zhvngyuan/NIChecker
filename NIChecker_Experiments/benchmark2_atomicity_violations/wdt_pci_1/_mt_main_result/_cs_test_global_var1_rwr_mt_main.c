/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-22 13:24:34
 ***
 ...
 ***
 ***  params:
 ***    --input /home/dell/zyworkspace/nichecker/Experiment/Testrealpro/wdt_pci_1/_mt_main.c --unwind 2 --rounds 2
 ***
 ***  mode:
 ***    rwr
 ***    int
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {1, 4, 3, 1, 1, 1};
...
IF(2,0,tcloser1_isr_0_1)
                                   ...
                                   __cs_local_closer1_isr___cs_tmp_if_cond_5 = count;
                                   ...
                                   __cs_local_closer1_isr___cs_tmp_if_cond_7 = expect_close != 42;
                                   ...
                                   ;
                                             ...
                                             __cs_local_closer1_isr___cs_tmp_if_cond_8 = test_global_condition1 == 1;
...
tcloser1_isr_0_1: IF(2,1,tcloser1_isr_0_2)
                                             ...
                                             __cs_local_closer1_isr___cs_tmp_if_cond_9 = test_global_condition2 == 1;
...
IF(3,0,tcloser2_isr_0_1)
                                   ...
                                   static int __cs_local_closer2_isr_reader5;
                                   __cs_local_closer2_isr_reader5 = nondet_int();
                                   
                                   static int __cs_local_closer2_isr_reader6;
                                   __cs_local_closer2_isr_reader6 = nondet_int();
...
/* main_task_0 */
                                   ...
                                   if (((__cs_disable_thread[1] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 3))) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 1)))
                                   {
