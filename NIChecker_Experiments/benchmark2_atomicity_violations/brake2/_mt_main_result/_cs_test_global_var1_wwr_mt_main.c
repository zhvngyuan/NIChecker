/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-22 13:22:23
 ***
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[2] __cs_thread_lines[] = {1, 3, 1, 2, 1};
...
IF(1,0,tmain_task_0_1)
                                   ...
                                   test_global_var1 = 0;
                                             ...
                                             wwr_w_tmp1_num++; //add
                                             wwr_w_tmp1 = test_global_var1; //add
...
IF(3,0,ttask_RR_Wheel_isr_0_1)
                                   ...
                                   test_global_var1 = 0;
                                             ...
                                             wwr_w_tmp3_num++; //add
                                             wwr_w_tmp3 = test_global_var1; //add
...
/* task_FL_Wheel_isr_0 random prio:5 */
                                   ...
                                   if ((__cs_disable_thread[4] != 1) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 2)))
                                   {
...
/* main_task_0 */
                                   ...
                                   if (((__cs_disable_thread[1] != 1) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 2))) && ((__cs_pc[4] == 0) || (__cs_pc[4] == 1)))
                                   {
