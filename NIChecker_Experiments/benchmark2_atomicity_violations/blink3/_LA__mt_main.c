...

{
          ...
          _Bool __cs_tmp_if_cond_0; __cs_tmp_if_cond_0 = (timerCount == 1); 
...

{
          ...
          _Bool __cs_tmp_if_cond_1; __cs_tmp_if_cond_1 = (timerCount == 1); 
...

{
          ...
          _Bool __cs_tmp_if_cond_2; __cs_tmp_if_cond_2 = (timerCount == 1); 
