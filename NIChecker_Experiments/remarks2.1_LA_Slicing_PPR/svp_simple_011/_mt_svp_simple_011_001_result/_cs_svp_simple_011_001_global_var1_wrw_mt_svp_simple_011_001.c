/***
 ***  generated by CSeq [ 0000 / 0000 ] 2024-06-03 21:09:13
 ***
...
#define NULL 0
                         ...
                         int* __cs_variable_address = &svp_simple_011_001_global_var1;   //add 
...
IF(2,0,tsvp_simple_011_001_isr_1_0_1)
                                   ...
                                   __cs_local_svp_simple_011_001_isr_1_reader2 = nondet_int();
                                   ...
                                   __cs_local_svp_simple_011_001_isr_1_reader1 = * __cs_local_svp_simple_011_001_isr_1_m;
                                           ...
                                           if(__cs_local_svp_simple_011_001_isr_1_m == __cs_variable_address) {
                                             wrw_a_1 = 1; //add
...
tmain_task_0_1: IF(1,1,tmain_task_0_2)
                                   ...
                                   * __cs_local_main_task_p = 0x01;
                                           ...
                                           if(__cs_local_main_task_p == __cs_variable_address) {
                                   ...
                                   * __cs_local_main_task_q = 0x02;
                                           ...
                                           if(__cs_local_main_task_q == __cs_variable_address) {
                                             if(wrw_a_1_num != 0){  //add
                                             	 assert(wrw_a_1 == 0);
                                             }
                                             wrw_a_1_num++;
