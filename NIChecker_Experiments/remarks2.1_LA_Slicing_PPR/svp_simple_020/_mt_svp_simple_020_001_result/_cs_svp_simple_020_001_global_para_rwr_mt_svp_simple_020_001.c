/***
 ***  generated by CSeq [ 0000 / 0000 ] 2024-06-03 21:10:36
 ***
 ...
 ***
 ***  params:
 ***    --input /home/dell/zyworkspace/nichecker/Experiment/remarks2.1_LA_Slicing_PPR/svp_simple_020/_mt_svp_simple_020_001.c --unwind 2 --rounds 2
 ***
 ***  mode:
 ***    rwr
 ***    int
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {1, 4, 3, 1};
                         ...
                         int* __cs_variable_address = &svp_simple_020_001_global_para;   //add 
...
tmain_task_0_1: IF(1,1,tmain_task_0_2)
                                   ...
                                   static int __cs_local_main_task_svp_simple_020_001_local_var1;
                                   
                                   static int __cs_local_main_task_svp_simple_020_001_local_var2;
                                   ...
                                   __cs_local_main_task___cs_tmp_if_cond_0 = (__cs_local_main_task_svp_simple_020_001_local_var1 + __cs_local_main_task_svp_simple_020_001_local_var2) > svp_simple_020_001_global_para;
                                             ...
                                             rwr_r1 = svp_simple_020_001_global_para; //add
...
tmain_task_0_2: IF(1,2,tmain_task_0_3)
                                   ...
                                   __cs_local_main_task___cs_tmp_if_cond_1 = (__cs_local_main_task_svp_simple_020_001_local_var1 + __cs_local_main_task_svp_simple_020_001_local_var2) < svp_simple_020_001_global_para;
                                             ...
                                             rwr_r2 = svp_simple_020_001_global_para; //add
                                             if(rwr_tmp1_num != 0){  //add
...
IF(3,0,tsvp_simple_020_001_isr_2_0_1)
                                   
                                   static _Bool __cs_local_svp_simple_020_001_isr_2___cs_tmp_if_cond_2;
...
IF(2,0,tsvp_simple_020_001_isr_1_0_1)
                                   
                                   svp_simple_020_001_global_flag = 1;
                                   
tsvp_simple_020_001_isr_1_0_1: IF(2,1,tsvp_simple_020_001_isr_1_0_2)
...
tsvp_simple_020_001_isr_1_0_2: IF(2,2,tsvp_simple_020_001_isr_1_0_3)
...
/* svp_simple_020_001_isr_1_0 random prio:1 */
                                   ...
                                   if (__cs_disable_thread[2] != 1)
                                   {
                                             ...
                                             svp_simple_020_001_isr_1_0(__cs_threadargs[2]);
                                             
                                             __cs_pc[2] = __cs_pc_cs[2];
                                   }
                         
                                   
/* svp_simple_020_001_isr_2_0 random prio:2 */
                                   ...
                                   if (__cs_disable_thread[3] != 1)
                                   {
                                             ...
                                             svp_simple_020_001_isr_2_0(__cs_threadargs[3]);
