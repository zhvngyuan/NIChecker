/***
 ***  generated by CSeq [ 0000 / 0000 ] 2024-06-03 21:09:38
 ***
 ...
 ***
 ***  params:
 ***    --input /home/dell/zyworkspace/nichecker/Experiment/remarks2.1_LA_Slicing_PPR/svp_simple_014/_mt_svp_simple_014_001.c --unwind 2 --rounds 2
 ***
 ***  mode:
 ***    rwr
 ***    int
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {1, 2, 5, 3, 1};
...
/* main_task_0 */
                                   ...
                                   if (((__cs_disable_thread[1] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 5))) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 3)))
                                   {
