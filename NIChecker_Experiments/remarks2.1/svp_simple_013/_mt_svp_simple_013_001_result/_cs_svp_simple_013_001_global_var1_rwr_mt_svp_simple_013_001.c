/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-04 12:12:47
 ***
 ...
 ***
 ***  params:
 ***    --input /home/dell/zyworkspace/nichecker/Experiment/remarks2.1/svp_simple_013/_mt_svp_simple_013_001.c --unwind 2 --rounds 2
 ***
 ***  mode:
 ***    rwr
 ***    int
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {1, 5, 2, 3, 1};
...
/* main_task_0 */
                                   ...
                                   if (((__cs_disable_thread[1] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 2))) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 3)))
                                   {
