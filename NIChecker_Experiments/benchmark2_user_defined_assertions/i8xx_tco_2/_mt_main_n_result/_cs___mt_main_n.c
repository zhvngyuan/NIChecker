/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-24 08:50:01
 ***
 ...
 ***
 ***  params:
 ***    --input /home/dell/zyworkspace/nichecker/Experiment/icbmc/i8xx_tco_2/_mt_main_n.c --unwind 2 --rounds 2
 ***
 ***  mode:
 ***
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[4] __cs_thread_lines[] = {5, 1, 8, 12, 7, 1};
...
IF(3,0,tcloser2_isr_0_1)
                                   ...
                                   tco_write_buf = 'V';
                         
                                             {
                                                       ...
                                                       __cs_local_closer2_isr___cs_tmp_if_cond_5 = 1;
...
tcloser2_isr_0_3: IF(3,3,tcloser2_isr_0_4)
                                                                           ...
                                                                           __cs_local_closer2_isr___cs_tmp_if_cond_7 = tco_write_buf == 'V';
...
tcloser2_isr_0_7: IF(3,7,tcloser2_isr_0_8)
                                                       ...
                                                       __cs_local_closer2_isr___cs_tmp_if_cond_8 = tco_expect_close == 42;
...
tcloser2_isr_0_11: IF(3,11,tcloser2_isr_0_12)
...
twriter1_isr_0_3: IF(4,3,twriter1_isr_0_4)
                                                                           ...
                                                                           __cs_local_writer1_isr___cs_tmp_if_cond_11 = tco_write_buf == 'V';
...
IF(5,0,twriter2_isr_0_1)
                         
                                             {
                         
                                                                 {
                                                       
                                                       static _Bool __cs_local_writer2_isr___cs_tmp_if_cond_12;
                                                       
                                                       __cs_local_writer2_isr___cs_tmp_if_cond_12 = 0;
                                                       
                                                       if (__cs_local_writer2_isr___cs_tmp_if_cond_12)
                         
                                                                                     {
                                                                 
                                                                 static _Bool __cs_local_writer2_isr___cs_tmp_if_cond_13;
                                                                 
                                                                 __cs_local_writer2_isr___cs_tmp_if_cond_13 = ! nowayout;
                                                                 
                                                                 if (__cs_local_writer2_isr___cs_tmp_if_cond_13)
                         
                                                                                                         {
                                                                           
                                                                           tco_expect_close = 0;
                                                                           
                                                                           static _Bool __cs_local_writer2_isr___cs_tmp_if_cond_14;
                                                                           
                                                                           __cs_local_writer2_isr___cs_tmp_if_cond_14 = tco_write_buf == 'V';
                                                                           
                                                                           if (__cs_local_writer2_isr___cs_tmp_if_cond_14)
...
/* closer1_isr_0 random prio:1 */
                                   ...
                                   if (((__cs_disable_thread[2] != 1) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 12))) && ((__cs_pc[4] == 0) || (__cs_pc[4] == 7)))
                                   {
...
/* closer2_isr_0 random prio:2 */
                                   ...
                                   if ((__cs_disable_thread[3] != 1) && ((__cs_pc[4] == 0) || (__cs_pc[4] == 7)))
                                   {
...
/* writer1_isr_0 random prio:2 */
                                   ...
                                   if ((__cs_disable_thread[4] != 1) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 12)))
                                   {
...
/* writer2_isr_0 random prio:3 */
                                   ...
                                   if (__cs_disable_thread[5] != 1)
                                   {
                                             ...
                                             writer2_isr_0(__cs_threadargs[5]);
...
/* main_task_0 */
                                   ...
                                   if ((((__cs_disable_thread[1] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 8))) && ((__cs_pc[3] == 0) || (__cs_pc[3] == 12))) && ((__cs_pc[4] == 0) || (__cs_pc[4] == 7)))
                                   {
