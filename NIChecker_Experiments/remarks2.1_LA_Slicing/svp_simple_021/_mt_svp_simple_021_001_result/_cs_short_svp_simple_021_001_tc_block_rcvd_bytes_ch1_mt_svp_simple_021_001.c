/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-09-30 10:39:33
 ***
...
tmain_task_0_4: IF(1,4,tmain_task_0_5)
                                                       ...
                                                       if (! ((__cs_local_main_task_t < 2) && (__cs_local_main_task_i < 256)))
...
tmain_task_0_6: IF(1,6,tmain_task_0_7)
                                                       ...
                                                       __cs_loop_1 = (__cs_local_main_task_t < 2) && (__cs_local_main_task_i < 256);
...
tmain_task_0_7: IF(1,7,tmain_task_0_8)
                                   ...
                                   if (! ((__cs_local_main_task_t < 4) && (__cs_local_main_task_ichan < 2)))
...
tmain_task_0_31: IF(1,31,tmain_task_0_32)
                                   ...
                                   __cs_loop_2 = (__cs_local_main_task_t < 4) && (__cs_local_main_task_ichan < 2);
