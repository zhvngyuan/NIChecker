/***
 ***  generated by CSeq [ 0000 / 0000 ] 2024-06-03 21:55:29
 ***
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[2] __cs_thread_lines[] = {3, 3, 1, 1};
...
/* main_task_0 */
                                   ...
                                   if ((__cs_disable_thread[1] != 1) && ((__cs_pc[2] == 0) || (__cs_pc[2] == 1)))
                                   {
