/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-15 16:24:06
 ***
 ...
 ***
 ***  params:
 ***    --input /home/dell/zyworkspace/nichecker/Experiment/remarks2.1_LA_Slice/svp_simple_024/_mt_svp_simple_024_001.c --unwind 2 --rounds 2
 ***
 ***  mode:
 ***    rwr
 ***    int
 ***    svp_simple_024_001_global_array
 ***
...
#define NULL 0
                         ...
                         unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {2, 5, 1};
...
IF(1,0,tmain_task_0_1)
                                   ...
                                   static struct bytetoword __cs_local_main_task_svp_simple_024_001_local_a;
                                   
                                   static struct bytetoword __cs_local_main_task_svp_simple_024_001_local_b;
                                   {
                                             {
                                   ...
                                   static unsigned int __cs_local_main_task___cs_retval__svp_simple_024_001_RTData_0;
                                   __cs_local_main_task___cs_retval__svp_simple_024_001_RTData_0 = nondet_uint();
                         
                                   {
                                             
                                             static struct bytetoword __cs_local_main_task_svp_simple_024_001_local_r;
...
tmain_task_0_1: IF(1,1,tmain_task_0_2)
                                             ...
                                             rwr_r1 = svp_simple_024_001_global_array[1]; //add
...
tmain_task_0_2: IF(1,2,tmain_task_0_3)
                                   ...
                                   static unsigned int __cs_local_main_task___cs_retval__svp_simple_024_001_RTData_1;
                                   __cs_local_main_task___cs_retval__svp_simple_024_001_RTData_1 = nondet_uint();
...
tmain_task_0_4: IF(1,4,tmain_task_0_5)
                                             ...
                                             rwr_r2 = svp_simple_024_001_global_array[1]; //add
                                             if(rwr_tmp1_num != 0){  //add
                                   ...
                                   static int __cs_local_main_task_svp_simple_024_001_local_casereg;
                                   __cs_local_main_task_svp_simple_024_001_local_casereg = __cs_local_main_task_svp_simple_024_001_local_a.worddata | (__cs_local_main_task_svp_simple_024_001_local_b.worddata & 0x02f0);
...
IF(2,0,tsvp_simple_024_001_isr_1_0_1)
                         
                                             {
                                             
                                             static int __cs_local_svp_simple_024_001_isr_1_i;
                                             
                                             __cs_local_svp_simple_024_001_isr_1_i = 0;
                                             
                                             static int __cs_local_svp_simple_024_001_isr_1_loop_1_IOVar1;
                                             
                                             static int __cs_local_svp_simple_024_001_isr_1_loop_1_block_1;
                                             
                                             static int __cs_local_svp_simple_024_001_isr_1_t;
                                             __cs_local_svp_simple_024_001_isr_1_t = 0;
                                             ...
                                             __cs_loop_1 = (__cs_local_svp_simple_024_001_isr_1_t < 2) && (__cs_local_svp_simple_024_001_isr_1_i < 100);
...
/* svp_simple_024_001_isr_1_0 random prio:1 */
                                   ...
                                   if (__cs_disable_thread[2] != 1)
                                   {
                                             ...
                                             svp_simple_024_001_isr_1_0(__cs_threadargs[2]);
