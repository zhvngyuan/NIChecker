...

{
          ...
          _Bool __cs_tmp_if_cond_1; __cs_tmp_if_cond_1 = (svp_simple_013_001_global_flag1 == 1); 
          ...
          _Bool __cs_tmp_if_cond_2; __cs_tmp_if_cond_2 = (svp_simple_013_001_global_flag2 == 1); 
