/***
 ***  generated by CSeq [ 0000 / 0000 ] 2023-10-15 16:48:40
 ***
 ...
 ***
 ***  params:
 ***    --input /home/dell/zyworkspace/nichecker/Experiment/remarks2.1_LA/svp_simple_022/_mt_svp_simple_022_001.c --unwind 2 --rounds 2
 ***
 ***  mode:
 ***    wwr
 ***    int
...
#define NULL 0
                         ...
                         int* __cs_variable_address = &svp_simple_022_001_global_var1;   //add 
...
tmain_task_0_3: IF(1,3,tmain_task_0_4)
                                   svp_simple_022_001_global_var1 = 0;
                                             ...
                                             wwr_w_tmp1_num++; //add
                                             wwr_w_tmp1 = svp_simple_022_001_global_var1; //add
...
tmain_task_0_4: IF(1,4,tmain_task_0_5)
                                             ...
                                             wwr_r1 = svp_simple_022_001_global_var1; //add
                                             if(wwr_w_tmp1_num != 0){
...
tmain_task_0_10: IF(1,10,tmain_task_0_11)
                                             ...
                                             wwr_r2 = svp_simple_022_001_global_var1; //add
                                             if(wwr_w_tmp1_num != 0){
...
IF(2,0,tsvp_simple_022_001_isr_1_0_1)
                                   svp_simple_022_001_global_var1 = nondet_rand();
...
/* svp_simple_022_001_isr_1_0 random prio:1 */
                                   ...
                                   if (__cs_disable_thread[2] != 1)
                                   {
                                             ...
                                             svp_simple_022_001_isr_1_0(__cs_threadargs[2]);
