/***
 ***  generated by CSeq [ 0000 / 0000 ] 2024-09-27 09:10:19
 ***
 ...
 ***
 ***  params:
 ***    --input /home/dell/zyworkspace/nichecker/Experiment/remarks2.1_basic/svp_simple_023/_mt_svp_simple_023_001.c --unwind 2 --rounds 2 --contexts 0 --cores 4
 ***
 ***  mode:
 ***    rww
 ***    int
...
#define NULL 0
                         ...
                         int* __cs_variable_address = &svp_simple_023_001_global_var;   //add 
...
tmain_task_0_1: IF(1,1,tmain_task_0_2)
                                             ...
                                             static int __cs_local_main_task_var;
                                             __cs_local_main_task_var = svp_simple_023_001_global_var;
                         
                                             rww_r_tmp1_num++; //add
                                             rww_r_tmp1 = svp_simple_023_001_global_var; //add
...
tmain_task_0_3: IF(1,3,tmain_task_0_4)
                                             ...
                                             rww_w1 = svp_simple_023_001_global_var; //add
                                             if(rww_r_tmp1_num != 0){
...
IF(2,0,tsvp_simple_023_001_isr_1_0_1)
                                   svp_simple_023_001_global_var = nondet_rand();
...
/* svp_simple_023_001_isr_1_0 random prio:1 */
                                   ...
                                   if (__cs_disable_thread[2] != 1)
                                   {
                                             ...
                                             svp_simple_023_001_isr_1_0(__cs_threadargs[2]);
