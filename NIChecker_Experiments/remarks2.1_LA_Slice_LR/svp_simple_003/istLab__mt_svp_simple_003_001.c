...

{
          ...
          disable_isr(2);
                    ...
                    _Bool __cs_loop_2 = (__cs_local_main_task_t_2 < 2) && (__cs_local_main_task_j > 0);
          ...
          enable_isr(1);
                    ...
                    _Bool __cs_loop_3 = (__cs_local_main_task_t_3 < 1) && (__cs_local_main_task_i < 10000);
                    ...
                    _Bool __cs_loop_4 = (__cs_local_main_task_t_4 < 1) && (__cs_local_main_task_j > 0);
