          ...
          int __cs_local_main_task_reader2;
                    ...
                    if (! ((__cs_local_main_task_t_1 < 2) && (__cs_local_main_task_i < 5)))
                              ...
                              __CPROVER_assume(__cs_local_main_task_i < 5);
                                                  ...
                                                  if (! ((__cs_local_main_task_t_2 < 1) && (__cs_local_main_task_j < 5)))
                                                  ...
                                                  _Bool __cs_loop_2 = (__cs_local_main_task_t_2 < 1) && (__cs_local_main_task_j < 5);
                    ...
                    if (! ((__cs_local_main_task_t_1 < 2) && (__cs_local_main_task_i < 5)))
                              ...
                              __CPROVER_assume(__cs_local_main_task_i < 5);
                                                  ...
                                                  _Bool __cs_loop_3 = (__cs_local_main_task_t_2 < 1) && (__cs_local_main_task_j < 5);
